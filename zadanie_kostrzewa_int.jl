...
for i in 1:100
    x_nowy, y_nowy = agent_step(xs[end], ys[end])
...
plot(circleShape(0,0,5), seriestype=[:shape,], lw=0.5, c=:blue, linecolor=:black, legend=false, fillalpha=0.1, aspect_ratio=1)
